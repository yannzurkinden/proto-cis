...
class Beneficiary(Base, TimestampMixin):
    ...
    # Administrative data
    ai_number: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    pension_type: Mapped[Optional[str]] = mapped_column(
        String(20), nullable=True
    )  # quarter, half, three_quarter, full
    guardianship_status: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    guardian_contact_id: Mapped[Optional[int]] = mapped_column(
    ...
    occupation_rate: Mapped[Optional[Decimal]] = mapped_column(Numeric(5, 2), nullable=True)
...
class BeneficiaryMedicalData(Base):
    ...
    medication: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
